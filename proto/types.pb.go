...
type Header struct {
	...
	Height    int32  `protobuf:"varint,2,opt,name=height,proto3" json:"height,omitempty"`       // Block 'height', or index in the blockchain
	PrevHash  []byte `protobuf:"bytes,3,opt,name=prevHash,proto3" json:"prevHash,omitempty"`    // Hash of the previous block
	RootHash  []byte `protobuf:"bytes,4,opt,name=rootHash,proto3" json:"rootHash,omitempty"`    // Merkle root hash of the transactions
	Timestamp int64  `protobuf:"varint,5,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // Unix timestamp of block creation
}
...
var file_proto_types_proto_rawDesc = []byte{
	...
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x65, 0x72, 0x7a, 0x73,
	0x31, 0x31, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
